...
print(sin_x(4))  # -0.6536398368228724
# Теперь при вызове имени и описании функции значения будут взяты у sin_x. Иначе были бы взяты у wrapper.
print(f"Имя функции: {sin_x.__name__}")  # Имя функции: sin_x
print(f"Описание функции: {sin_x.__doc__}")  # Описание функции: Функция для вычисления производной синуса.
